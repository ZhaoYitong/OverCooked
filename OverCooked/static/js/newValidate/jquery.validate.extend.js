...
jQuery.validator.addMethod("ageValid",function (value,element) {
    return this.optional(element) || (/^\d+$/.test(value) && value<=60 && value>=18);
}, "年龄必须在18到60岁之间");
...
// 验证是否为 excel 文件
jQuery.validator.addMethod( "isExcelFile", function( value, element) {
	return this.optional( element ) || value.match(/\.(xls[mx]?)$/ || /\.(xlsx[mx]?)$/ )
},"请上传正确的excel文件" );
